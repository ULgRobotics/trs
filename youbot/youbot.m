function youbot()
    ...
    while true
        ...
        elseif strcmp(fsm, 'extend')
            ...
            % If the arm is extended, move on to the next state. 
        ...
        elseif strcmp(fsm, 'grasp')
            %% Grasp the object by closing the gripper on it. TODO MATHIEU
            % Close the gripper. 
        ...
        elseif strcmp(fsm, 'backoff')
            %% Go back to rest position. TODO MATHIEU
